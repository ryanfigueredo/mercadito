    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-2xl mx-auto px-4">
        <Card className="p-8 text-center">
          ...
          {/* Instruções para pagamentos offline */}
          <div className="mb-6">
            ...
            <div className="text-gray-600 text-sm text-left space-y-2">
              <p>
                • Se você escolheu um método de pagamento offline (boleto, PIX
                manual), siga as instruções enviadas por e-mail
              </p>
              <p>
                • Para pagamentos com cartão, aguarde alguns minutos para a
                confirmação
              </p>
              <p>
              ...
              <p>
                • Em caso de dúvidas, entre em contato conosco através do
                suporte
              </p>
            </div>
          </div>
